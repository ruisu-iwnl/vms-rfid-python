from flask import Blueprint, render_template, flash, session, request, make_response
...
def admin_login():
    ...
    response = make_response(render_template('login/admin_login.html', form=form, recaptcha_error=recaptcha_error, login_error=login_error))
